		...
		{ // Reinforcements
			...
			for (final Map.Entry<String, Integer> entry : boss.getReinforcementsBoss().entrySet()) {
				...
				if (reinforcement == null)
					Common.warning("Cannot spawn reinforcement as the Boss '" + name + "' does not exist (if the name contains a number, edit your Boss yml file and add ' ,' between Boss name and the quantity");
